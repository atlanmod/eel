 ...
 * </p>
 * <ul>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.MeasureImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.MeasureImpl#getSubname <em>Subname</em>}</li>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.MeasureImpl#getTargetClass <em>Target Class</em>}</li>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.MeasureImpl#getTargetOperation <em>Target Operation</em>}</li>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.MeasureImpl#getPost <em>Post</em>}</li>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.MeasureImpl#getUncertainty <em>Uncertainty</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MeasureImpl extends MinimalEObjectImpl.Container implements Measure {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate NAME__ESETTING_DELEGATE = ((EStructuralFeature.Internal) EelPackage.Literals.MEASURE__NAME)
			.getSettingDelegate();
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate POST__ESETTING_DELEGATE = ((EStructuralFeature.Internal) EelPackage.Literals.MEASURE__POST)
			.getSettingDelegate();
	...
	public void setTargetClass(String newTargetClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASURE__TARGET_CLASS, oldTargetClass,
					targetClass));
	}
	...
	public void setTargetOperation(String newTargetOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASURE__TARGET_OPERATION,
	...
	public NotificationChain basicSetUncertainty(MeasurementUncertainty newUncertainty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EelPackage.MEASURE__UNCERTAINTY, oldUncertainty, newUncertainty);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setUncertainty(MeasurementUncertainty newUncertainty) {
		if (newUncertainty != uncertainty) {
			...
			if (uncertainty != null)
				msgs = ((InternalEObject) uncertainty).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EelPackage.MEASURE__UNCERTAINTY, null, msgs);
			if (newUncertainty != null)
				msgs = ((InternalEObject) newUncertainty).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - EelPackage.MEASURE__UNCERTAINTY, null, msgs);
			msgs = basicSetUncertainty(newUncertainty, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASURE__UNCERTAINTY, newUncertainty,
					newUncertainty));
	}
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate TYPE__EINVOCATION_DELEGATE = ((EOperation.Internal) EelPackage.Literals.MEASURE___TYPE)
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate VALUE__EINVOCATION_DELEGATE = ((EOperation.Internal) EelPackage.Literals.MEASURE___VALUE)
			.getInvocationDelegate();
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate NAME__EINVOCATION_DELEGATE = ((EOperation.Internal) EelPackage.Literals.MEASURE___NAME)
			.getInvocationDelegate();
	...
	public boolean eIsSet(int featureID) {
		...
		case EelPackage.MEASURE__TARGET_OPERATION:
			return TARGET_OPERATION_EDEFAULT == null ? targetOperation != null
					: !TARGET_OPERATION_EDEFAULT.equals(targetOperation);
		case EelPackage.MEASURE__POST:
