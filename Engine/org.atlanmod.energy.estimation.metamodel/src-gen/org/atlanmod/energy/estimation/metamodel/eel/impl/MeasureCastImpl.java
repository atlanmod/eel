 ...
 * </p>
 * <ul>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.MeasureCastImpl#getMeasure <em>Measure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasureCastImpl extends TypedMeasureImpl implements MeasureCast {
		...
		if (measure != null && measure.eIsProxy()) {
			...
			if (measure != oldMeasure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EelPackage.MEASURE_CAST__MEASURE,
							oldMeasure, measure));
			}
		}
		return measure;
	...
	public void setMeasure(Measure newMeasure) {
		...
		measure = newMeasure;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASURE_CAST__MEASURE, oldMeasure,
					measure));
	}
