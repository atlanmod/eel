...
public class MeasureUnboundSumOperationImpl extends MeasureUnboundOperationImpl implements MeasureUnboundSumOperation {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate VALUE__EINVOCATION_DELEGATE = ((EOperation.Internal) EelPackage.Literals.MEASURE_UNBOUND_SUM_OPERATION___VALUE)
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Measure.class) {
			...
			case EelPackage.MEASURE___VALUE:
				return EelPackage.MEASURE_UNBOUND_SUM_OPERATION___VALUE;
			default:
