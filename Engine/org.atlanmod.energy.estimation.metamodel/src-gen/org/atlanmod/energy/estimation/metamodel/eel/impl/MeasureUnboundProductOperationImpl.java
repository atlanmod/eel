 ...
 * @generated
 */
public class MeasureUnboundProductOperationImpl extends MeasureUnboundOperationImpl
		implements MeasureUnboundProductOperation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return EelPackage.Literals.MEASURE_UNBOUND_PRODUCT_OPERATION;
	}
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate VALUE__EINVOCATION_DELEGATE = ((EOperation.Internal) EelPackage.Literals.MEASURE_UNBOUND_PRODUCT_OPERATION___VALUE)
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Measure.class) {
			...
			case EelPackage.MEASURE___VALUE:
				return EelPackage.MEASURE_UNBOUND_PRODUCT_OPERATION___VALUE;
			default:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case EelPackage.MEASURE_UNBOUND_PRODUCT_OPERATION___VALUE:
			return value();
		}
