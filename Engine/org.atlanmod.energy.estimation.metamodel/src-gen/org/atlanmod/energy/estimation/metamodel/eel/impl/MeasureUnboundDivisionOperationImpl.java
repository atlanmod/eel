 ...
 * @generated
 */
public class MeasureUnboundDivisionOperationImpl extends MeasureUnboundOperationImpl
		implements MeasureUnboundDivisionOperation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return EelPackage.Literals.MEASURE_UNBOUND_DIVISION_OPERATION;
	}
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate VALUE__EINVOCATION_DELEGATE = ((EOperation.Internal) EelPackage.Literals.MEASURE_UNBOUND_DIVISION_OPERATION___VALUE)
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Measure.class) {
			...
			case EelPackage.MEASURE___VALUE:
				return EelPackage.MEASURE_UNBOUND_DIVISION_OPERATION___VALUE;
			default:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case EelPackage.MEASURE_UNBOUND_DIVISION_OPERATION___VALUE:
			return value();
		}
