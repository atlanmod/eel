 ...
 * </p>
 * <ul>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.LogisticMeasureImpl#getL <em>L</em>}</li>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.LogisticMeasureImpl#getK <em>K</em>}</li>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.LogisticMeasureImpl#getX0 <em>X0</em>}</li>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.LogisticMeasureImpl#getX <em>X</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogisticMeasureImpl extends CompositeMeasureImpl implements LogisticMeasure {
	...
	public Measure getX0() {
		if (x0 != null && x0.eIsProxy()) {
			...
			if (x0 != oldX0) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EelPackage.LOGISTIC_MEASURE__X0, oldX0,
							x0));
			}
		}
		return x0;
