 ...
 * </p>
 * <ul>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.IntegralImpl#getInterval <em>Interval</em>}</li>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.IntegralImpl#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegralImpl extends MeasurementUncertaintyInformationImpl implements Integral {
		...
		if (interval != null && interval.eIsProxy()) {
			...
			if (interval != oldInterval) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EelPackage.INTEGRAL__INTERVAL,
	...
	public void setInterval(Interval newInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.INTEGRAL__INTERVAL, oldInterval,
					interval));
	}
	...
	public void setFunction(String newFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.INTEGRAL__FUNCTION, oldFunction,
					function));
	}
