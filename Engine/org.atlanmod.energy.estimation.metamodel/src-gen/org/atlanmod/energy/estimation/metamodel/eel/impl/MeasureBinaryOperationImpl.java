 ...
 * </p>
 * <ul>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.MeasureBinaryOperationImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.atlanmod.energy.estimation.metamodel.eel.impl.MeasureBinaryOperationImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MeasureBinaryOperationImpl extends TypedMeasureImpl implements MeasureBinaryOperation {
		...
		if (left != null && left.eIsProxy()) {
			...
			if (left != oldLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EelPackage.MEASURE_BINARY_OPERATION__LEFT,
							oldLeft, left));
			}
		}
		return left;
	...
	public void setLeft(Measure newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASURE_BINARY_OPERATION__LEFT, oldLeft,
					left));
	}
			...
			if (right != oldRight) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EelPackage.MEASURE_BINARY_OPERATION__RIGHT, oldRight, right));
			}
		}
		return right;
	}
	...
	public void setRight(Measure newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASURE_BINARY_OPERATION__RIGHT, oldRight,
					right));
	}
