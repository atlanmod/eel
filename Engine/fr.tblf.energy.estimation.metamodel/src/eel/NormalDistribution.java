 ...
 * </p>
 * <ul>
 *   <li>{@link eel.NormalDistribution#getMeanValue <em>Mean Value</em>}</li>
 *   <li>{@link eel.NormalDistribution#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 *
 * @see eel.EelPackage#getNormalDistribution()
 * @model
 * @generated
 */
public interface NormalDistribution extends MeasurementUncertaintyInformation {
	 ...
	 * @see eel.EelPackage#getNormalDistribution_MeanValue()
	 * @model derived="true"
	...
	/**
	 * Sets the value of the '{@link eel.NormalDistribution#getMeanValue <em>Mean Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eel.EelPackage#getNormalDistribution_StandardDeviation()
	 * @model derived="true"
	...
	/**
	 * Sets the value of the '{@link eel.NormalDistribution#getStandardDeviation <em>Standard Deviation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
