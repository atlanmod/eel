...
public class RealTimeDurationImpl extends MeasureValueImpl implements RealTimeDuration {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate TYPE__EINVOCATION_DELEGATE = ((EOperation.Internal)EelPackage.Literals.REAL_TIME_DURATION___TYPE).getInvocationDelegate();
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Measure.class) {
			switch (baseOperationID) {
				case EelPackage.MEASURE___TYPE: return EelPackage.REAL_TIME_DURATION___TYPE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == TypedMeasure.class) {
			switch (baseOperationID) {
				case EelPackage.TYPED_MEASURE___TYPE: return EelPackage.REAL_TIME_DURATION___TYPE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
