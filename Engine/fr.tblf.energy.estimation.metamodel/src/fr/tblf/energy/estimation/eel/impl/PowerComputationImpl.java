...
public class PowerComputationImpl extends MeasureProductOperationImpl implements PowerComputation {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate TYPE__EINVOCATION_DELEGATE = ((EOperation.Internal)EelPackage.Literals.POWER_COMPUTATION___TYPE).getInvocationDelegate();
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate VALUE__EINVOCATION_DELEGATE = ((EOperation.Internal)EelPackage.Literals.POWER_COMPUTATION___VALUE).getInvocationDelegate();
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Measure.class) {
			switch (baseOperationID) {
				case EelPackage.MEASURE___TYPE: return EelPackage.POWER_COMPUTATION___TYPE;
				case EelPackage.MEASURE___VALUE: return EelPackage.POWER_COMPUTATION___VALUE;
