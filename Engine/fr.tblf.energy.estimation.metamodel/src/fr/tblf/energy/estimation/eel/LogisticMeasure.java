 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tblf.energy.estimation.eel.LogisticMeasure#getL <em>L</em>}</li>
 *   <li>{@link fr.tblf.energy.estimation.eel.LogisticMeasure#getK <em>K</em>}</li>
 *   <li>{@link fr.tblf.energy.estimation.eel.LogisticMeasure#getX0 <em>X0</em>}</li>
 *   <li>{@link fr.tblf.energy.estimation.eel.LogisticMeasure#getX <em>X</em>}</li>
 * </ul>
 *
 * @see fr.tblf.energy.estimation.eel.EelPackage#getLogisticMeasure()
 * @model
 * @generated
 */
public interface LogisticMeasure extends CompositeMeasure {
	 ...
	 * @see #setL(Measure)
	 * @see fr.tblf.energy.estimation.eel.EelPackage#getLogisticMeasure_L()
	 * @model required="true"
	 * @generated
	 */
	Measure getL();
	...
	/**
	 * Sets the value of the '{@link fr.tblf.energy.estimation.eel.LogisticMeasure#getL <em>L</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setK(Measure)
	 * @see fr.tblf.energy.estimation.eel.EelPackage#getLogisticMeasure_K()
	 * @model required="true"
	 * @generated
	 */
	Measure getK();
	...
	/**
	 * Sets the value of the '{@link fr.tblf.energy.estimation.eel.LogisticMeasure#getK <em>K</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setX0(Measure)
	 * @see fr.tblf.energy.estimation.eel.EelPackage#getLogisticMeasure_X0()
	 * @model required="true"
	 * @generated
	 */
	Measure getX0();
	...
	/**
	 * Sets the value of the '{@link fr.tblf.energy.estimation.eel.LogisticMeasure#getX0 <em>X0</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setX(Measure)
	 * @see fr.tblf.energy.estimation.eel.EelPackage#getLogisticMeasure_X()
	 * @model required="true"
	 * @generated
	 */
	Measure getX();
	...
	/**
	 * Sets the value of the '{@link fr.tblf.energy.estimation.eel.LogisticMeasure#getX <em>X</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
