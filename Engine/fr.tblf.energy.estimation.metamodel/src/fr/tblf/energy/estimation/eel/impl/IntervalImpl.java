 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.IntervalImpl#getLowerEndpoint <em>Lower Endpoint</em>}</li>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.IntervalImpl#getUpperEndpoint <em>Upper Endpoint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntervalImpl extends MeasurementUncertaintyInformationImpl implements Interval {
	...
	public NotificationChain basicSetLowerEndpoint(Measure newLowerEndpoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EelPackage.INTERVAL__LOWER_ENDPOINT, oldLowerEndpoint, newLowerEndpoint);
	...
	public void setLowerEndpoint(Measure newLowerEndpoint) {
		if (newLowerEndpoint != lowerEndpoint) {
			...
			if (lowerEndpoint != null)
				msgs = ((InternalEObject)lowerEndpoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EelPackage.INTERVAL__LOWER_ENDPOINT, null, msgs);
			if (newLowerEndpoint != null)
				msgs = ((InternalEObject)newLowerEndpoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EelPackage.INTERVAL__LOWER_ENDPOINT, null, msgs);
			msgs = basicSetLowerEndpoint(newLowerEndpoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.INTERVAL__LOWER_ENDPOINT, newLowerEndpoint, newLowerEndpoint));
	}
	...
	public NotificationChain basicSetUpperEndpoint(Measure newUpperEndpoint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EelPackage.INTERVAL__UPPER_ENDPOINT, oldUpperEndpoint, newUpperEndpoint);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUpperEndpoint(Measure newUpperEndpoint) {
		if (newUpperEndpoint != upperEndpoint) {
			...
			if (upperEndpoint != null)
				msgs = ((InternalEObject)upperEndpoint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EelPackage.INTERVAL__UPPER_ENDPOINT, null, msgs);
			if (newUpperEndpoint != null)
				msgs = ((InternalEObject)newUpperEndpoint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EelPackage.INTERVAL__UPPER_ENDPOINT, null, msgs);
			msgs = basicSetUpperEndpoint(newUpperEndpoint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.INTERVAL__UPPER_ENDPOINT, newUpperEndpoint, newUpperEndpoint));
	}
