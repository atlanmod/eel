 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.MeasureOCLImpl#getOclQuery <em>Ocl Query</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasureOCLImpl extends MeasureValueImpl implements MeasureOCL {
	...
	public void setOclQuery(String newOclQuery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASURE_OCL__OCL_QUERY, oldOclQuery, oclQuery));
	}
