 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.VariableImpl#getValue <em>Value</em>}</li>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.VariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.VariableImpl#getVibility <em>Vibility</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends MinimalEObjectImpl.Container implements Variable {
	...
	public void setVibility(Visibility newVibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.VARIABLE__VIBILITY, oldVibility, vibility));
	}
