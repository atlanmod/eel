 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.ExponentialMeasureImpl#getX <em>X</em>}</li>
 * </ul>
 *
 * @generated
 */
		...
		if (x != null && x.eIsProxy()) {
			...
			if (x != oldX) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EelPackage.EXPONENTIAL_MEASURE__X, oldX, x));
			}
		}
		return x;
	}
