 ...
 * @generated
 */
public class EnergyComputationImpl extends MeasureProductOperationImpl implements EnergyComputation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate TYPE__EINVOCATION_DELEGATE = ((EOperation.Internal)EelPackage.Literals.ENERGY_COMPUTATION___TYPE).getInvocationDelegate();
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate VALUE__EINVOCATION_DELEGATE = ((EOperation.Internal)EelPackage.Literals.ENERGY_COMPUTATION___VALUE).getInvocationDelegate();
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Measure.class) {
			switch (baseOperationID) {
				case EelPackage.MEASURE___TYPE: return EelPackage.ENERGY_COMPUTATION___TYPE;
				case EelPackage.MEASURE___VALUE: return EelPackage.ENERGY_COMPUTATION___VALUE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == MeasureProductOperation.class) {
			switch (baseOperationID) {
				case EelPackage.MEASURE_PRODUCT_OPERATION___VALUE: return EelPackage.ENERGY_COMPUTATION___VALUE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
