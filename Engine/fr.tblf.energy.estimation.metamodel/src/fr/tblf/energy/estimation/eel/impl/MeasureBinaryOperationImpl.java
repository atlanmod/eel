 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.MeasureBinaryOperationImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.MeasureBinaryOperationImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MeasureBinaryOperationImpl extends TypedMeasureImpl implements MeasureBinaryOperation {
	...
	protected EClass eStaticClass() {
		return EelPackage.Literals.MEASURE_BINARY_OPERATION;
	}
		...
		if (left != null && left.eIsProxy()) {
			...
			if (left != oldLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EelPackage.MEASURE_BINARY_OPERATION__LEFT, oldLeft, left));
			}
		}
		return left;
	}
	...
	public void setLeft(Measure newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASURE_BINARY_OPERATION__LEFT, oldLeft, left));
	}
	...
	public Measure getRight() {
		if (right != null && right.eIsProxy()) {
			...
			if (right != oldRight) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EelPackage.MEASURE_BINARY_OPERATION__RIGHT, oldRight, right));
			}
		}
		return right;
	}
	...
	public void setRight(Measure newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASURE_BINARY_OPERATION__RIGHT, oldRight, right));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EelPackage.MEASURE_BINARY_OPERATION__LEFT:
				if (resolve) return getLeft();
				return basicGetLeft();
			case EelPackage.MEASURE_BINARY_OPERATION__RIGHT:
