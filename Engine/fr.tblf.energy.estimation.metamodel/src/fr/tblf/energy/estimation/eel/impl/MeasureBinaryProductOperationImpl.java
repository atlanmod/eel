...
public class MeasureBinaryProductOperationImpl extends MeasureBinaryOperationImpl implements MeasureBinaryProductOperation {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate VALUE__EINVOCATION_DELEGATE = ((EOperation.Internal)EelPackage.Literals.MEASURE_BINARY_PRODUCT_OPERATION___VALUE).getInvocationDelegate();
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Measure.class) {
			switch (baseOperationID) {
				case EelPackage.MEASURE___VALUE: return EelPackage.MEASURE_BINARY_PRODUCT_OPERATION___VALUE;
