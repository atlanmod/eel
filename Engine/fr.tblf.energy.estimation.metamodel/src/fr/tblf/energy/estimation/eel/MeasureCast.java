 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tblf.energy.estimation.eel.MeasureCast#getMeasure <em>Measure</em>}</li>
 * </ul>
 *
 * @see fr.tblf.energy.estimation.eel.EelPackage#getMeasureCast()
 * @model
 * @generated
 */
public interface MeasureCast extends TypedMeasure {
	 ...
	 * @see fr.tblf.energy.estimation.eel.EelPackage#getMeasureCast_Measure()
	 * @model required="true"
	 * @generated
	 */
	Measure getMeasure();
	...
	/**
	 * Sets the value of the '{@link fr.tblf.energy.estimation.eel.MeasureCast#getMeasure <em>Measure</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
