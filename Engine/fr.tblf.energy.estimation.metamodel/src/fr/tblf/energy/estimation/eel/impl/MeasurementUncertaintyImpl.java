 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.MeasurementUncertaintyImpl#getInformation <em>Information</em>}</li>
 *   <li>{@link fr.tblf.energy.estimation.eel.impl.MeasurementUncertaintyImpl#getStandardUncertainty <em>Standard Uncertainty</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasurementUncertaintyImpl extends MinimalEObjectImpl.Container implements MeasurementUncertainty {
	...
	public NotificationChain basicSetInformation(MeasurementUncertaintyInformation newInformation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EelPackage.MEASUREMENT_UNCERTAINTY__INFORMATION, oldInformation, newInformation);
	...
	public void setInformation(MeasurementUncertaintyInformation newInformation) {
		if (newInformation != information) {
			...
			if (information != null)
				msgs = ((InternalEObject)information).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EelPackage.MEASUREMENT_UNCERTAINTY__INFORMATION, null, msgs);
			if (newInformation != null)
				msgs = ((InternalEObject)newInformation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EelPackage.MEASUREMENT_UNCERTAINTY__INFORMATION, null, msgs);
			msgs = basicSetInformation(newInformation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASUREMENT_UNCERTAINTY__INFORMATION, newInformation, newInformation));
	}
	...
	public void setStandardUncertainty(BigDecimal newStandardUncertainty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EelPackage.MEASUREMENT_UNCERTAINTY__STANDARD_UNCERTAINTY, oldStandardUncertainty, standardUncertainty));
	}
