...
/**
 * This is the item provider adapter for a {@link fr.tblf.energy.estimation.eel.MeasureBinaryOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EelPackage.Literals.MEASURE_BINARY_OPERATION__LEFT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EelPackage.Literals.MEASURE_BINARY_OPERATION__RIGHT,
				 true,
				 false,
				 true,
				 null,
