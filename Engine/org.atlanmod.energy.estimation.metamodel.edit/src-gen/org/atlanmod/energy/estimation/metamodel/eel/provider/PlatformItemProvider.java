...
/**
 * This is the item provider adapter for a {@link org.atlanmod.energy.estimation.metamodel.eel.Platform} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlatformItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Platform_name_feature",
								"_UI_Platform_type"),
						EelPackage.Literals.PLATFORM__NAME, true, false, false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(EelPackage.Literals.PLATFORM__VARIABLES, EelFactory.eINSTANCE.createVariable()));
		...
		newChildDescriptors.add(
				createChildParameter(EelPackage.Literals.PLATFORM__MEASURES, EelFactory.eINSTANCE.createMeasureOCL()));

		newChildDescriptors.add(createChildParameter(EelPackage.Literals.PLATFORM__MEASURES,
				EelFactory.eINSTANCE.createMeasureAttribute()));

		newChildDescriptors.add(
				createChildParameter(EelPackage.Literals.PLATFORM__MEASURES, EelFactory.eINSTANCE.createMeasureCast()));
