...
/**
 * This is the item provider adapter for a {@link org.atlanmod.energy.estimation.metamodel.eel.MeasureUnboundOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasureUnboundOperationItemProvider extends TypedMeasureItemProvider {
	...
	protected void addMeasuresPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MeasureUnboundOperation_measures_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_MeasureUnboundOperation_measures_feature",
								"_UI_MeasureUnboundOperation_type"),
						EelPackage.Literals.MEASURE_UNBOUND_OPERATION__MEASURES, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_MeasureUnboundOperation_type")
