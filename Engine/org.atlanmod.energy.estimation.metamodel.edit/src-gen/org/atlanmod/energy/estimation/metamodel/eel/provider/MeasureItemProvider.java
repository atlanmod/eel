...
/**
 * This is the item provider adapter for a {@link org.atlanmod.energy.estimation.metamodel.eel.Measure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasureItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						EelPackage.Literals.MEASURE__NAME, true, false, false,
	...
	protected void addSubnamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Measure_subname_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Measure_subname_feature",
								"_UI_Measure_type"),
						EelPackage.Literals.MEASURE__SUBNAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTargetClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Measure_targetClass_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Measure_targetClass_feature",
								"_UI_Measure_type"),
						EelPackage.Literals.MEASURE__TARGET_CLASS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTargetOperationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Measure_targetOperation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Measure_targetOperation_feature",
								"_UI_Measure_type"),
						EelPackage.Literals.MEASURE__TARGET_OPERATION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPostPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Measure_post_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Measure_post_feature", "_UI_Measure_type"),
						EelPackage.Literals.MEASURE__POST, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EelPackage.Literals.MEASURE__UNCERTAINTY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(EelPackage.Literals.MEASURE__UNCERTAINTY,
				EelFactory.eINSTANCE.createMeasurementUncertainty()));
	}
