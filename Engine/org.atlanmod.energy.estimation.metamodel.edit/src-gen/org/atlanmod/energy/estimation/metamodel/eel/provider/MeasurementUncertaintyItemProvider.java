...
/**
 * This is the item provider adapter for a {@link org.atlanmod.energy.estimation.metamodel.eel.MeasurementUncertainty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasurementUncertaintyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addStandardUncertaintyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_MeasurementUncertainty_standardUncertainty_feature", "_UI_MeasurementUncertainty_type"),
				EelPackage.Literals.MEASUREMENT_UNCERTAINTY__STANDARD_UNCERTAINTY, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EelPackage.Literals.MEASUREMENT_UNCERTAINTY__INFORMATION);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_MeasurementUncertainty_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(EelPackage.Literals.MEASUREMENT_UNCERTAINTY__INFORMATION,
				EelFactory.eINSTANCE.createNormalDistribution()));

		newChildDescriptors.add(createChildParameter(EelPackage.Literals.MEASUREMENT_UNCERTAINTY__INFORMATION,
				EelFactory.eINSTANCE.createInterval()));

		newChildDescriptors.add(createChildParameter(EelPackage.Literals.MEASUREMENT_UNCERTAINTY__INFORMATION,
				EelFactory.eINSTANCE.createSampling()));

		newChildDescriptors.add(createChildParameter(EelPackage.Literals.MEASUREMENT_UNCERTAINTY__INFORMATION,
				EelFactory.eINSTANCE.createIntegral()));
	}
