...
/**
 * This is the item provider adapter for a {@link org.atlanmod.energy.estimation.metamodel.eel.NormalDistribution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NormalDistributionItemProvider extends MeasurementUncertaintyInformationItemProvider {
	...
	protected void addMeanValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_NormalDistribution_meanValue_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_NormalDistribution_meanValue_feature",
								"_UI_NormalDistribution_type"),
						EelPackage.Literals.NORMAL_DISTRIBUTION__MEAN_VALUE, true, false, false,
	...
	protected void addStandardDeviationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_NormalDistribution_standardDeviation_feature",
						"_UI_NormalDistribution_type"),
				EelPackage.Literals.NORMAL_DISTRIBUTION__STANDARD_DEVIATION, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_NormalDistribution_type")
